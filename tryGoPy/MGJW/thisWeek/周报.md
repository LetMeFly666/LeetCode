 ...
 * @LastEditTime: 2025-03-21 23:09:47
-->
# 命令行添加证书
...
![sender](pics/sender.png)

![receiver](pics/receiver.png)
...
![显示结果](pics/show-result.png)

其中的1和3实质上是将内容显示为白色，2实质上是直接不显示。

![显示结果-选中](pics/show-xuanzhong.png)
...
![无参数](pics/github-noParameters.png)
