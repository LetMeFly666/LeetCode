        ...
        <div class="container">
            ...
            <div class="collapse navbar-collapse" id="navbarNav">
                <ul class="navbar-nav ms-auto">
                    <li class="nav-item">
                        <a class="nav-link" href="/webex/"><i class="bi bi-house-door me-1"></i> 首页</a>
                    </li>
                    <li class="nav-item">
                        <a class="nav-link" href="/webex/encode"><i class="bi bi-lock me-1"></i> 编码</a>
                    </li>
                    <li class="nav-item">
                        <a class="nav-link" href="/webex/admin"><i class="bi bi-speedometer2 me-1"></i> 管理后台</a>
                    </li>
                </ul>
            </div>
        </div>
    ...
    <div class="hero-section">
        <div class="container text-center">
            ...
            <div class="d-flex justify-content-center gap-3">
                <a href="/webex/encode" class="btn btn-light btn-lg px-4 py-2 fw-bold">
                    <i class="bi bi-lock me-2"></i>开始编码
                </a>
                <a href="/webex/admin" class="btn btn-outline-light btn-lg px-4 py-2">
        ...
        <div class="card mb-5">
            ...
            <div class="card-body">
                ...
                <div class="text-center mt-4">
                    <a href="/webex/encode" class="btn btn-primary btn-lg">
...
@webex_blueprint.route('/encode', methods=['GET', 'POST'])
def encode_page():
    """编码页面"""
                ...
                <div class="card-body">
                    ...
                    <div class="result-box mt-4">
                        ...
                        <ul>
                            ...
                            <li>可在<a href="/webex/admin">管理后台</a>查看匹配状态</li>
                        </ul>
                    </div>
                </div>
            </div>
...
def admin_page():
    ...
    <div class="container my-5">
        <div class="d-flex justify-content-between align-items-center mb-4">
            ...
            <a href="/webex/encode" class="btn btn-primary">
