...
LastEditTime: 2025-12-08 23:42:04
'''
...
for slug in slugs:
    ...
    if int(num) not in skipList:
        cmd = f'gh issue create -t "[newSolution]Who can add 1 more problem of LeetCode {num}" -b "By [recentPerDay.py](https://github.com/LetMeFly666/LeetCode/blob/d8caeb7e08275d2f8096a7468373e3bdfeae7346/tryGoPy/ReLeetcode/recentPerDay.py) using GH on Windows | [{name}](https://leetcode.cn/problems/{slug}) " -l "题解" -a "@me"'
        cmds.append(cmd)

print('\nGenerated by [d8caeb](https://github.com/LetMeFly666/LeetCode/blob/d8caeb7e08275d2f8096a7468373e3bdfeae7346/tryGoPy/ReLeetcode/recentPerDay.py)\'s next version') # 永远跟不上的版本
for cmd in cmds:
    print(cmd)
