---
title: 3483.不同三位偶数的数目：暴力枚举
date: 2026-09-11 08:30:09
tags: [题解, LeetCode, 简单, 递归, 数组, 哈希表, 枚举, 暴力]
categories: [题解, LeetCode]
---

# 【LetMeFly】3483.不同三位偶数的数目：暴力枚举
...
使用一个大小为$1000$的布尔类型的数组作为哈希表，去重可以组成的三位偶数。

三重循环枚举所有的三位数，第一重要求不为$0$，第二重要求和第一重下标不同，第三重要求和前两重下标不同且必须是偶数。

如果枚举到一个还没有出现过的三位数，则答案累加$1$并将该三位数标记为出现过。

+ 时间复杂度$O(len(digits)^3)$
+ 空间复杂度$O(C)$，其中$C=10^3$

### AC代码

> 同步发文于[CSDN](https://letmefly.blog.csdn.net/article/details/164948656)和我的[个人博客](https://blog.letmefly.xyz/)，原创不易，转载经作者同意后请附上[原文链接](https://blog.letmefly.xyz/2026/09/11/LeetCode%203483.%E4%B8%8D%E5%90%8C%E4%B8%89%E4%BD%8D%E5%81%B6%E6%95%B0%E7%9A%84%E6%95%B0%E7%9B%AE/)哦~
>
