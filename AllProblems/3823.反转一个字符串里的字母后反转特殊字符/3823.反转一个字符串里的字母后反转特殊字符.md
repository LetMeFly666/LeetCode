---
title: 3823.反转一个字符串里的字母后反转特殊字符
date: 2026-02-10 23-00-26
tags: [题解, LeetCode, 简单, 双指针, 字符串, 模拟]
---

# 【LetMeFly】3823.反转一个字符串里的字母后反转特殊字符

力扣题目链接：[https://leetcode.cn/problems/reverse-letters-then-special-characters-in-a-string/](https://leetcode.cn/problems/reverse-letters-then-special-characters-in-a-string/)
