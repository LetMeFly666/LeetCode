...
date: 2022-06-02 20-14-14
tags: [题解, LeetCode, 中等, 贪心, 哈希表, 字符串, 计数, 堆（优先队列）]
---

# 【LetMeFly】2182.构造限制重复的字符串

力扣题目链接：[https://leetcode.cn/problems/construct-string-with-repeat-limit/](https://leetcode.cn/problems/construct-string-with-repeat-limit/)
