---
title: 3777.使子字符串变交替的最少删除次数
date: 2026-02-10 23-00-05
tags: [题解, LeetCode, 困难, 线段树, 字符串]
---

# 【LetMeFly】3777.使子字符串变交替的最少删除次数

力扣题目链接：[https://leetcode.cn/problems/minimum-deletions-to-make-alternating-substring/](https://leetcode.cn/problems/minimum-deletions-to-make-alternating-substring/)
