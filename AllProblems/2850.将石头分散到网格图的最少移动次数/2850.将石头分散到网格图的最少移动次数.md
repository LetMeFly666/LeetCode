...
tags: [题解, LeetCode, 中等, 位运算, 数组, 动态规划, 回溯, 位掩码, 矩阵]
---

# 【LetMeFly】2850.将石头分散到网格图的最少移动次数

力扣题目链接：[https://leetcode.cn/problems/minimum-moves-to-spread-stones-over-grid/](https://leetcode.cn/problems/minimum-moves-to-spread-stones-over-grid/)
