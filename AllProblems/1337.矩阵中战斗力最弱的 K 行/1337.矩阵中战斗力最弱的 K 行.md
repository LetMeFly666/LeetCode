...
date: 2022-06-02 20-05-32
tags: [题解, LeetCode, 简单, 数组, 二分查找, 矩阵, 排序, 堆（优先队列）]
---

# 【LetMeFly】1337.矩阵中战斗力最弱的 K 行

力扣题目链接：[https://leetcode.cn/problems/the-k-weakest-rows-in-a-matrix/](https://leetcode.cn/problems/the-k-weakest-rows-in-a-matrix/)
