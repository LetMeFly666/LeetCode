...
tags: [题解, LeetCode, 中等, 栈, 深度优先搜索, 字符串]
---

# 【LetMeFly】388.文件的最长绝对路径

力扣题目链接：[https://leetcode.cn/problems/longest-absolute-file-path/](https://leetcode.cn/problems/longest-absolute-file-path/)
