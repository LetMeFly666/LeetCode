...
tags: [题解, LeetCode, 困难, 位运算, 树, 深度优先搜索, 记忆化搜索, 数组, 动态规划]
---

# 【LetMeFly】2920.收集所有金币可获得的最大积分

力扣题目链接：[https://leetcode.cn/problems/maximum-points-after-collecting-coins-from-all-nodes/](https://leetcode.cn/problems/maximum-points-after-collecting-coins-from-all-nodes/)
