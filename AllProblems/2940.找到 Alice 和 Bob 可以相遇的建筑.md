...
date: 2024-01-24 13-55-27
tags: [题解, LeetCode, 困难, 栈, 树状数组, 线段树, 数组, 二分查找, 单调栈, 堆（优先队列）]
---

# 【LetMeFly】2940.找到 Alice 和 Bob 可以相遇的建筑

力扣题目链接：[https://leetcode.cn/problems/find-building-where-alice-and-bob-can-meet/](https://leetcode.cn/problems/find-building-where-alice-and-bob-can-meet/)
