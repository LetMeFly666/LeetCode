...
tags: [题解, LeetCode, 中等, 贪心, 数组, 数学, 二分查找, 排序]
---

# 【LetMeFly】2967.使数组成为等数数组的最小代价

力扣题目链接：[https://leetcode.cn/problems/minimum-cost-to-make-array-equalindromic/](https://leetcode.cn/problems/minimum-cost-to-make-array-equalindromic/)
