...
date: 2022-06-02 20-07-02
tags: [题解, LeetCode, 中等, 数组, 哈希表, 计数]
---

# 【LetMeFly】1497.检查数组对是否可以被 k 整除

力扣题目链接：[https://leetcode.cn/problems/check-if-array-pairs-are-divisible-by-k/](https://leetcode.cn/problems/check-if-array-pairs-are-divisible-by-k/)
