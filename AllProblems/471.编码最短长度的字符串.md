...
# 【LetMeFly】471.编码最短长度的字符串

力扣题目链接：[https://leetcode.cn/problems/encode-string-with-shortest-length/](https://leetcode.cn/problems/encode-string-with-shortest-length/)
