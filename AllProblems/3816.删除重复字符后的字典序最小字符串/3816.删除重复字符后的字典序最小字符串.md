---
title: 3816.删除重复字符后的字典序最小字符串
date: 2026-02-10 23-00-23
tags: [题解, LeetCode, 困难, 栈, 贪心, 哈希表, 字符串, 单调栈]
---

# 【LetMeFly】3816.删除重复字符后的字典序最小字符串

力扣题目链接：[https://leetcode.cn/problems/lexicographically-smallest-string-after-deleting-duplicate-characters/](https://leetcode.cn/problems/lexicographically-smallest-string-after-deleting-duplicate-characters/)
