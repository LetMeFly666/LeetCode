...
tags: [题解, LeetCode, 困难, 位运算, 字典树, 数组, 哈希表, 字符串]
---

# 【LetMeFly】1178.猜字谜

力扣题目链接：[https://leetcode.cn/problems/number-of-valid-words-for-each-puzzle/](https://leetcode.cn/problems/number-of-valid-words-for-each-puzzle/)
