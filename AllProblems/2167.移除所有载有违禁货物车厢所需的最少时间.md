...
# 【LetMeFly】2167.移除所有载有违禁货物车厢所需的最少时间

力扣题目链接：[https://leetcode.cn/problems/minimum-time-to-remove-all-cars-containing-illegal-goods/](https://leetcode.cn/problems/minimum-time-to-remove-all-cars-containing-illegal-goods/)
