...
tags: [题解, LeetCode, 中等, 贪心, 字符串, 枚举]
---

# 【LetMeFly】2800.包含三个字符串的最短字符串

力扣题目链接：[https://leetcode.cn/problems/shortest-string-that-contains-three-strings/](https://leetcode.cn/problems/shortest-string-that-contains-three-strings/)
