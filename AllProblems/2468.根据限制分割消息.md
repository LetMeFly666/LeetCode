...
tags: [题解, LeetCode, 困难, 字符串, 二分查找, 枚举]
---

# 【LetMeFly】2468.根据限制分割消息

力扣题目链接：[https://leetcode.cn/problems/split-message-based-on-limit/](https://leetcode.cn/problems/split-message-based-on-limit/)
