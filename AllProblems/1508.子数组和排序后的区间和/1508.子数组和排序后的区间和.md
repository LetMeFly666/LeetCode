...
date: 2022-06-02 20-07-09
tags: [题解, LeetCode, 中等, 数组, 双指针, 二分查找, 前缀和, 排序]
---

# 【LetMeFly】1508.子数组和排序后的区间和

力扣题目链接：[https://leetcode.cn/problems/range-sum-of-sorted-subarray-sums/](https://leetcode.cn/problems/range-sum-of-sorted-subarray-sums/)
