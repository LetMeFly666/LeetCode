...
tags: [题解, LeetCode, 中等, 字符串, 动态规划, 前缀和]
---

# 【LetMeFly】2222.选择建筑的方案数

力扣题目链接：[https://leetcode.cn/problems/number-of-ways-to-select-buildings/](https://leetcode.cn/problems/number-of-ways-to-select-buildings/)
