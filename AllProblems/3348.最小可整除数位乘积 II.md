...
tags: [题解, LeetCode, 困难, 贪心, 数学, 字符串, 回溯, 数论]
---

# 【LetMeFly】3348.最小可整除数位乘积 II

力扣题目链接：[https://leetcode.cn/problems/smallest-divisible-digit-product-ii/](https://leetcode.cn/problems/smallest-divisible-digit-product-ii/)
