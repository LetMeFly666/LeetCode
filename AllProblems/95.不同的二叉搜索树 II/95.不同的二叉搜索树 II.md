...
tags: [题解, LeetCode, 中等, 树, 二叉搜索树, 动态规划, 回溯, 二叉树]
---

# 【LetMeFly】95.不同的二叉搜索树 II

力扣题目链接：[https://leetcode.cn/problems/unique-binary-search-trees-ii/](https://leetcode.cn/problems/unique-binary-search-trees-ii/)
