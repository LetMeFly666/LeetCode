...
tags: [题解, LeetCode, 中等, 设计, 数组, 哈希表]
---

# 【LetMeFly】1865.找出和为指定值的下标对

力扣题目链接：[https://leetcode.cn/problems/finding-pairs-with-a-certain-sum/](https://leetcode.cn/problems/finding-pairs-with-a-certain-sum/)
