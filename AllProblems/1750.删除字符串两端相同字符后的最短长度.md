...
# 【LetMeFly】1750.删除字符串两端相同字符后的最短长度

力扣题目链接：[https://leetcode.cn/problems/minimum-length-of-string-after-deleting-similar-ends/](https://leetcode.cn/problems/minimum-length-of-string-after-deleting-similar-ends/)
