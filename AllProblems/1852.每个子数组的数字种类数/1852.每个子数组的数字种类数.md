...
date: 2022-06-02 20-10-48
tags: [题解, LeetCode, 中等, 数组, 哈希表, 滑动窗口]
---

# 【LetMeFly】1852.每个子数组的数字种类数

力扣题目链接：[https://leetcode.cn/problems/distinct-numbers-in-each-subarray/](https://leetcode.cn/problems/distinct-numbers-in-each-subarray/)
