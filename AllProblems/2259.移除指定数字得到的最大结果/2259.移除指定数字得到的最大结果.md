...
tags: [题解, LeetCode, 简单, 贪心, 字符串, 枚举]
---

# 【LetMeFly】2259.移除指定数字得到的最大结果

力扣题目链接：[https://leetcode.cn/problems/remove-digit-from-number-to-maximize-result/](https://leetcode.cn/problems/remove-digit-from-number-to-maximize-result/)
