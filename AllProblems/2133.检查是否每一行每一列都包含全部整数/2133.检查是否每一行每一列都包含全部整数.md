...
date: 2022-06-02 20-13-44
tags: [题解, LeetCode, 简单, 数组, 哈希表, 矩阵]
---

# 【LetMeFly】2133.检查是否每一行每一列都包含全部整数

力扣题目链接：[https://leetcode.cn/problems/check-if-every-row-and-column-contains-all-numbers/](https://leetcode.cn/problems/check-if-every-row-and-column-contains-all-numbers/)
