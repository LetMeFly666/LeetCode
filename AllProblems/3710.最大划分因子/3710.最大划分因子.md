...
tags: [题解, LeetCode, 困难, 深度优先搜索, 广度优先搜索, 并查集, 图, 数组, 二分查找]
---

# 【LetMeFly】3710.最大划分因子

力扣题目链接：[https://leetcode.cn/problems/maximum-partition-factor/](https://leetcode.cn/problems/maximum-partition-factor/)
