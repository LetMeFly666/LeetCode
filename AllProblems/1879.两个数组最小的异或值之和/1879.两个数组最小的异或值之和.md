...
date: 2022-06-02 20-11-06
tags: [题解, LeetCode, 困难, 位运算, 数组, 动态规划, 位掩码]
---

# 【LetMeFly】1879.两个数组最小的异或值之和

力扣题目链接：[https://leetcode.cn/problems/minimum-xor-sum-of-two-arrays/](https://leetcode.cn/problems/minimum-xor-sum-of-two-arrays/)
