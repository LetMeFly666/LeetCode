...
date: 2022-06-02 20-11-39
tags: [题解, LeetCode, 简单, 字符串]
---

# 【LetMeFly】1933.判断字符串是否可分解为值均等的子串

力扣题目链接：[https://leetcode.cn/problems/check-if-string-is-decomposable-into-value-equal-substrings/](https://leetcode.cn/problems/check-if-string-is-decomposable-into-value-equal-substrings/)
