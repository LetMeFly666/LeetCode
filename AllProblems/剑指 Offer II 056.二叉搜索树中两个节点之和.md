...
tags: [题解, LeetCode, 简单, 树, 深度优先搜索, 广度优先搜索, 二叉搜索树, 哈希表, 双指针, 二叉树]
---

# 【LetMeFly】剑指 Offer II 056.二叉搜索树中两个节点之和

力扣题目链接：[https://leetcode.cn/problems/opLdQZ/](https://leetcode.cn/problems/opLdQZ/)
