...
date: 2023-01-03 18-53-29
tags: [题解, LeetCode, 困难, 树, 深度优先搜索, 数组, 数学, 枚举]
---

# 【LetMeFly】2440.创建价值相同的连通块

力扣题目链接：[https://leetcode.cn/problems/create-components-with-same-value/](https://leetcode.cn/problems/create-components-with-same-value/)
