---
title: 3767.选择 K 个任务的最大总分数
date: 2026-02-10 23-00-00
tags: [题解, LeetCode, 中等, 贪心, 数组, 排序, 堆（优先队列）]
---

# 【LetMeFly】3767.选择 K 个任务的最大总分数

力扣题目链接：[https://leetcode.cn/problems/maximize-points-after-choosing-k-tasks/](https://leetcode.cn/problems/maximize-points-after-choosing-k-tasks/)
