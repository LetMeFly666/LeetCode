...
tags: [题解, LeetCode, 中等, 树, 深度优先搜索, 广度优先搜索, 数组, 哈希表, 字符串]
---

# 【LetMeFly】1257.最小公共区域

力扣题目链接：[https://leetcode.cn/problems/smallest-common-region/](https://leetcode.cn/problems/smallest-common-region/)
