---
title: 839.相似字符串组
date: 2022-06-02 20-01-04
tags: [题解, LeetCode, 困难, 深度优先搜索, 广度优先搜索, 并查集, 数组, 哈希表, 字符串]
---

# 【LetMeFly】839.相似字符串组

力扣题目链接：[https://leetcode.cn/problems/similar-string-groups/](https://leetcode.cn/problems/similar-string-groups/)
