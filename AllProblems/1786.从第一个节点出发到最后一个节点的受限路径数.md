...
date: 2022-06-02 20-10-02
tags: [题解, LeetCode, 中等, 图, 拓扑排序, 动态规划, 最短路, 堆（优先队列）]
---

# 【LetMeFly】1786.从第一个节点出发到最后一个节点的受限路径数

力扣题目链接：[https://leetcode.cn/problems/number-of-restricted-paths-from-first-to-last-node/](https://leetcode.cn/problems/number-of-restricted-paths-from-first-to-last-node/)
