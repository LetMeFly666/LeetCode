...
# 【LetMeFly】1752.检查数组是否经排序和轮转得到

力扣题目链接：[https://leetcode.cn/problems/check-if-array-is-sorted-and-rotated/](https://leetcode.cn/problems/check-if-array-is-sorted-and-rotated/)
