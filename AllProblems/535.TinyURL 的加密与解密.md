...
tags: [题解, LeetCode, 中等, 设计, 哈希表, 字符串, 哈希函数]
---

# 【LetMeFly】535.TinyURL 的加密与解密

力扣题目链接：[https://leetcode.cn/problems/encode-and-decode-tinyurl/](https://leetcode.cn/problems/encode-and-decode-tinyurl/)
