...
tags: [题解, LeetCode, 中等, 贪心, 字典树, 线段树, 数组, 字符串, 二分查找, 动态规划, 字符串匹配, 哈希函数, 滚动哈希]
---

# 【LetMeFly】3291.形成目标字符串需要的最少字符串数 I

力扣题目链接：[https://leetcode.cn/problems/minimum-number-of-valid-strings-to-form-target-i/](https://leetcode.cn/problems/minimum-number-of-valid-strings-to-form-target-i/)
