---
title: LCP 09.最小跳跃次数
date: 2022-06-02 20-15-18
tags: [题解, LeetCode, 困难, 广度优先搜索, 线段树, 数组, 动态规划]
---

# 【LetMeFly】LCP 09.最小跳跃次数

力扣题目链接：[https://leetcode.cn/problems/zui-xiao-tiao-yue-ci-shu/](https://leetcode.cn/problems/zui-xiao-tiao-yue-ci-shu/)
