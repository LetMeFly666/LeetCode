...
tags: [题解, LeetCode, 简单, 位运算, 字典树, 数组, 哈希表, 滑动窗口]
---

# 【LetMeFly】2932.找出强数对的最大异或值 I

力扣题目链接：[https://leetcode.cn/problems/maximum-strong-pair-xor-i/](https://leetcode.cn/problems/maximum-strong-pair-xor-i/)
