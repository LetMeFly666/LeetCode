...
# 【LetMeFly】1974.使用特殊打字机键入单词的最少时间

力扣题目链接：[https://leetcode.cn/problems/minimum-time-to-type-word-using-special-typewriter/](https://leetcode.cn/problems/minimum-time-to-type-word-using-special-typewriter/)
