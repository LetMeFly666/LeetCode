...
date: 2023-06-02 21-22-26
tags: [题解, LeetCode, 困难, 树, 并查集, 二叉搜索树, 记忆化搜索, 数组, 数学, 分治, 动态规划, 二叉树, 组合数学]
---

# 【LetMeFly】1569.将子数组重新排序得到同一个二叉搜索树的方案数

力扣题目链接：[https://leetcode.cn/problems/number-of-ways-to-reorder-array-to-get-same-bst/](https://leetcode.cn/problems/number-of-ways-to-reorder-array-to-get-same-bst/)
