...
# 【LetMeFly】1941.检查是否所有字符出现次数相同

力扣题目链接：[https://leetcode.cn/problems/check-if-all-characters-have-equal-number-of-occurrences/](https://leetcode.cn/problems/check-if-all-characters-have-equal-number-of-occurrences/)
