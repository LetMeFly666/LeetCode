---
title: 3910.统计节点和为偶数的连通子图
date: 2026-06-14 07-11-19
tags: [题解, LeetCode, 困难, 位运算, 深度优先搜索, 广度优先搜索, 并查集, 图, 数组, 枚举]
---

# 【LetMeFly】3910.统计节点和为偶数的连通子图

力扣题目链接：[https://leetcode.cn/problems/count-connected-subgraphs-with-even-node-sum/](https://leetcode.cn/problems/count-connected-subgraphs-with-even-node-sum/)
