...
tags: [题解, LeetCode, 简单, 哈希表, 数学, 前缀和]
---

# 【LetMeFly】2848.与车相交的点

力扣题目链接：[https://leetcode.cn/problems/points-that-intersect-with-cars/](https://leetcode.cn/problems/points-that-intersect-with-cars/)
