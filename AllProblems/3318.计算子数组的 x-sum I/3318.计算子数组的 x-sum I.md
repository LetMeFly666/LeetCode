...
tags: [题解, LeetCode, 简单, 数组, 哈希表, 滑动窗口, 堆（优先队列）]
---

# 【LetMeFly】3318.计算子数组的 x-sum I

力扣题目链接：[https://leetcode.cn/problems/find-x-sum-of-all-k-long-subarrays-i/](https://leetcode.cn/problems/find-x-sum-of-all-k-long-subarrays-i/)
