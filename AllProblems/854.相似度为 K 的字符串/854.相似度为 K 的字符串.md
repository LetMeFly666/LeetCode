...
tags: [题解, LeetCode, 困难, 广度优先搜索, 字符串]
---

# 【LetMeFly】854.相似度为 K 的字符串

力扣题目链接：[https://leetcode.cn/problems/k-similar-strings/](https://leetcode.cn/problems/k-similar-strings/)
