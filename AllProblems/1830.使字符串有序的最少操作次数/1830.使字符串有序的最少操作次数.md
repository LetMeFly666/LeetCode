...
date: 2022-06-02 20-10-30
tags: [题解, LeetCode, 困难, 哈希表, 数学, 字符串, 组合数学, 计数]
---

# 【LetMeFly】1830.使字符串有序的最少操作次数

力扣题目链接：[https://leetcode.cn/problems/minimum-number-of-operations-to-make-string-sorted/](https://leetcode.cn/problems/minimum-number-of-operations-to-make-string-sorted/)
