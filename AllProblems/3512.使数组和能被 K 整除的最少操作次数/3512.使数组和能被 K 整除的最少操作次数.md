---
title: 3512.使数组和能被 K 整除的最少操作次数
date: 2025-05-04 22-52-19
tags: [题解, LeetCode, 简单, 数组, 数学]
---

# 【LetMeFly】3512.使数组和能被 K 整除的最少操作次数

力扣题目链接：[https://leetcode.cn/problems/minimum-operations-to-make-array-sum-divisible-by-k/](https://leetcode.cn/problems/minimum-operations-to-make-array-sum-divisible-by-k/)
