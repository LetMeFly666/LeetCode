...
# 【LetMeFly】2220.转换数字的最少位翻转次数

力扣题目链接：[https://leetcode.cn/problems/minimum-bit-flips-to-convert-number/](https://leetcode.cn/problems/minimum-bit-flips-to-convert-number/)
