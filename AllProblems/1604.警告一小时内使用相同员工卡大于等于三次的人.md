...
date: 2022-06-02 20-08-06
tags: [题解, LeetCode, 中等, 数组, 哈希表, 字符串, 排序]
---

# 【LetMeFly】1604.警告一小时内使用相同员工卡大于等于三次的人

力扣题目链接：[https://leetcode.cn/problems/alert-using-same-key-card-three-or-more-times-in-a-one-hour-period/](https://leetcode.cn/problems/alert-using-same-key-card-three-or-more-times-in-a-one-hour-period/)
