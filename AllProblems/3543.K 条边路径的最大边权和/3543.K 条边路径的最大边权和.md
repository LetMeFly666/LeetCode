...
date: 2025-09-13 13-23-29
tags: [题解, LeetCode, 中等, 图, 哈希表, 动态规划]
---

# 【LetMeFly】3543.K 条边路径的最大边权和

力扣题目链接：[https://leetcode.cn/problems/maximum-weighted-k-edge-path/](https://leetcode.cn/problems/maximum-weighted-k-edge-path/)
