...
date: 2022-06-02 19-57-32
tags: [题解, LeetCode, 困难, 树, 深度优先搜索, 广度优先搜索, 字符串]
---

# 【LetMeFly】428.序列化和反序列化 N 叉树

力扣题目链接：[https://leetcode.cn/problems/serialize-and-deserialize-n-ary-tree/](https://leetcode.cn/problems/serialize-and-deserialize-n-ary-tree/)
