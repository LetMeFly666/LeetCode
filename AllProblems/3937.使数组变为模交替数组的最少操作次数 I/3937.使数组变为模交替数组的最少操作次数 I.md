---
title: 3937.使数组变为模交替数组的最少操作次数 I
date: 2026-06-14 09-11-53
tags: [题解, LeetCode, 中等, 数组, 枚举]
---

# 【LetMeFly】3937.使数组变为模交替数组的最少操作次数 I

力扣题目链接：[https://leetcode.cn/problems/minimum-operations-to-make-array-modulo-alternating-i/](https://leetcode.cn/problems/minimum-operations-to-make-array-modulo-alternating-i/)
