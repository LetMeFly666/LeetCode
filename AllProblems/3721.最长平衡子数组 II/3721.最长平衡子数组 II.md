...
tags: [题解, LeetCode, 困难, 线段树, 数组, 哈希表, 分治, 前缀和]
---

# 【LetMeFly】3721.最长平衡子数组 II

力扣题目链接：[https://leetcode.cn/problems/longest-balanced-subarray-ii/](https://leetcode.cn/problems/longest-balanced-subarray-ii/)
