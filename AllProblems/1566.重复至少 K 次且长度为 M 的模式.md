...
# 【LetMeFly】1566.重复至少 K 次且长度为 M 的模式

力扣题目链接：[https://leetcode.cn/problems/detect-pattern-of-length-m-repeated-k-or-more-times/](https://leetcode.cn/problems/detect-pattern-of-length-m-repeated-k-or-more-times/)
