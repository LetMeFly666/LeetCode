---
title: 3795.不同元素和至少为 K 的最短子数组长度
date: 2026-02-10 23-00-14
tags: [题解, LeetCode, 中等, 数组, 哈希表, 滑动窗口]
---

# 【LetMeFly】3795.不同元素和至少为 K 的最短子数组长度

力扣题目链接：[https://leetcode.cn/problems/minimum-subarray-length-with-distinct-sum-at-least-k/](https://leetcode.cn/problems/minimum-subarray-length-with-distinct-sum-at-least-k/)
