...
tags: [题解, LeetCode, 中等, 位运算, 数组, 哈希表, 数学, 前缀和]
---

# 【LetMeFly】1442.形成两个异或相等数组的三元组数目

力扣题目链接：[https://leetcode.cn/problems/count-triplets-that-can-form-two-arrays-of-equal-xor/](https://leetcode.cn/problems/count-triplets-that-can-form-two-arrays-of-equal-xor/)
