...
date: 2023-06-02 21-31-05
tags: [题解, LeetCode, 困难, 记忆化搜索, 数组, 哈希表, 二分查找, 动态规划, 矩阵, 有序集合, 排序]
---

# 【LetMeFly】2713.矩阵中严格递增的单元格数

力扣题目链接：[https://leetcode.cn/problems/maximum-strictly-increasing-cells-in-a-matrix/](https://leetcode.cn/problems/maximum-strictly-increasing-cells-in-a-matrix/)
