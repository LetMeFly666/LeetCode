...
tags: [题解, LeetCode, 简单, 字典树, 数组, 字符串, 字符串匹配, 哈希函数, 滚动哈希]
---

# 【LetMeFly】3042.统计前后缀下标对 I

力扣题目链接：[https://leetcode.cn/problems/count-prefix-and-suffix-pairs-i/](https://leetcode.cn/problems/count-prefix-and-suffix-pairs-i/)
