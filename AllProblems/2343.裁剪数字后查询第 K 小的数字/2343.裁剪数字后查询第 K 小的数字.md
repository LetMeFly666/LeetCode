...
tags: [题解, LeetCode, 中等, 数组, 字符串, 分治, 快速选择, 基数排序, 排序, 堆（优先队列）]
---

# 【LetMeFly】2343.裁剪数字后查询第 K 小的数字

力扣题目链接：[https://leetcode.cn/problems/query-kth-smallest-trimmed-number/](https://leetcode.cn/problems/query-kth-smallest-trimmed-number/)
