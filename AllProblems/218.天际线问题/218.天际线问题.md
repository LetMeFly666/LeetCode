---
title: 218.天际线问题
date: 2022-06-02 19-55-44
tags: [题解, LeetCode, 困难, 树状数组, 线段树, 数组, 分治, 有序集合, 排序, 扫描线, 堆（优先队列）]
---

# 【LetMeFly】218.天际线问题

力扣题目链接：[https://leetcode.cn/problems/the-skyline-problem/](https://leetcode.cn/problems/the-skyline-problem/)
