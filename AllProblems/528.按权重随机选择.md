---
title: 528.按权重随机选择
date: 2022-06-02 19-58-25
tags: [题解, LeetCode, 中等, 数组, 数学, 二分查找, 前缀和, 随机化]
---

# 【LetMeFly】528.按权重随机选择

力扣题目链接：[https://leetcode.cn/problems/random-pick-with-weight/](https://leetcode.cn/problems/random-pick-with-weight/)
