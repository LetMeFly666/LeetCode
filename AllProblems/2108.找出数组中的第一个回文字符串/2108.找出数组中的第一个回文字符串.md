...
tags: [题解, LeetCode, 简单, 数组, 双指针, 字符串]
---

# 【LetMeFly】2108.找出数组中的第一个回文字符串

力扣题目链接：[https://leetcode.cn/problems/find-first-palindromic-string-in-the-array/](https://leetcode.cn/problems/find-first-palindromic-string-in-the-array/)
