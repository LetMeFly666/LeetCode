...
date: 2022-06-02 20-06-28
tags: [题解, LeetCode, 简单, 数组]
---

# 【LetMeFly】1437.是否所有 1 都至少相隔 k 个元素

力扣题目链接：[https://leetcode.cn/problems/check-if-all-1s-are-at-least-length-k-places-away/](https://leetcode.cn/problems/check-if-all-1s-are-at-least-length-k-places-away/)
