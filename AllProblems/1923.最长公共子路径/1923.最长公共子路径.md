...
tags: [题解, LeetCode, 困难, 数组, 二分查找, 后缀数组, 哈希函数, 滚动哈希]
---

# 【LetMeFly】1923.最长公共子路径

力扣题目链接：[https://leetcode.cn/problems/longest-common-subpath/](https://leetcode.cn/problems/longest-common-subpath/)
