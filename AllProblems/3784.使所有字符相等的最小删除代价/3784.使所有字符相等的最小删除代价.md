---
title: 3784.使所有字符相等的最小删除代价
date: 2026-02-10 23-00-09
tags: [题解, LeetCode, 中等, 数组, 哈希表, 字符串, 枚举]
---

# 【LetMeFly】3784.使所有字符相等的最小删除代价

力扣题目链接：[https://leetcode.cn/problems/minimum-deletion-cost-to-make-all-characters-equal/](https://leetcode.cn/problems/minimum-deletion-cost-to-make-all-characters-equal/)
