...
tags: [题解, LeetCode, 困难, 贪心, 哈希表, 字符串, 排序]
---

# 【LetMeFly】1520.最多的不重叠子字符串

力扣题目链接：[https://leetcode.cn/problems/maximum-number-of-non-overlapping-substrings/](https://leetcode.cn/problems/maximum-number-of-non-overlapping-substrings/)
