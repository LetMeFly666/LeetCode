...
tags: [题解, LeetCode, 简单, 树, 深度优先搜索, 字符串, 二叉树]
---

# 【LetMeFly】606.根据二叉树创建字符串

力扣题目链接：[https://leetcode.cn/problems/construct-string-from-binary-tree/](https://leetcode.cn/problems/construct-string-from-binary-tree/)
