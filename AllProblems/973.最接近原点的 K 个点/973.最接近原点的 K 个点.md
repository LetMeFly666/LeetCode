...
tags: [题解, LeetCode, 中等, 几何, 数组, 数学, 分治, 快速选择, 排序, 堆（优先队列）]
---

# 【LetMeFly】973.最接近原点的 K 个点

力扣题目链接：[https://leetcode.cn/problems/k-closest-points-to-origin/](https://leetcode.cn/problems/k-closest-points-to-origin/)
