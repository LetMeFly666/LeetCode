...
tags: [题解, LeetCode, 中等, 数学, 字符串, 回溯, 枚举]
---

# 【LetMeFly】面试题 16.18.模式匹配

力扣题目链接：[https://leetcode.cn/problems/pattern-matching-lcci/](https://leetcode.cn/problems/pattern-matching-lcci/)
