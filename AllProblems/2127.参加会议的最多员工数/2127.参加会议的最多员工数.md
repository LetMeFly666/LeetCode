...
tags: [题解, LeetCode, 困难, 深度优先搜索, 图, 拓扑排序, 数组, 动态规划]
---

# 【LetMeFly】2127.参加会议的最多员工数

力扣题目链接：[https://leetcode.cn/problems/maximum-employees-to-be-invited-to-a-meeting/](https://leetcode.cn/problems/maximum-employees-to-be-invited-to-a-meeting/)
