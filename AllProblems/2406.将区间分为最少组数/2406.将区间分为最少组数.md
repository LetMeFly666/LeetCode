...
tags: [题解, LeetCode, 中等, 贪心, 数组, 双指针, 前缀和, 排序, 堆（优先队列）]
---

# 【LetMeFly】2406.将区间分为最少组数

力扣题目链接：[https://leetcode.cn/problems/divide-intervals-into-minimum-number-of-groups/](https://leetcode.cn/problems/divide-intervals-into-minimum-number-of-groups/)
