...
date: 2022-06-02 20-07-40
tags: [题解, LeetCode, 简单, 数据库]
---

# 【LetMeFly】1565.按月统计订单数与顾客数

力扣题目链接：[https://leetcode.cn/problems/unique-orders-and-customers-per-month/](https://leetcode.cn/problems/unique-orders-and-customers-per-month/)
