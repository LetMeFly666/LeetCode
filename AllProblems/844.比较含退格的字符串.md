---
title: 844.比较含退格的字符串
date: 2022-06-02 20-01-06
tags: [题解, LeetCode, 简单, 栈, 双指针, 字符串, 模拟]
---

# 【LetMeFly】844.比较含退格的字符串

力扣题目链接：[https://leetcode.cn/problems/backspace-string-compare/](https://leetcode.cn/problems/backspace-string-compare/)
