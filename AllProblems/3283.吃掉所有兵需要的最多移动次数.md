...
date: 2024-12-19 16-59-35
tags: [题解, LeetCode, 困难, 位运算, 广度优先搜索, 数组, 数学, 状态压缩, 博弈]
---

# 【LetMeFly】3283.吃掉所有兵需要的最多移动次数

力扣题目链接：[https://leetcode.cn/problems/maximum-number-of-moves-to-kill-all-pawns/](https://leetcode.cn/problems/maximum-number-of-moves-to-kill-all-pawns/)
