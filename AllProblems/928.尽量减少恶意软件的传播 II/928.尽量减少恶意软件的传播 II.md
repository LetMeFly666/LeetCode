...
date: 2022-06-02 20-01-52
tags: [题解, LeetCode, 困难, 深度优先搜索, 广度优先搜索, 并查集, 图, 数组, 哈希表]
---

# 【LetMeFly】928.尽量减少恶意软件的传播 II

力扣题目链接：[https://leetcode.cn/problems/minimize-malware-spread-ii/](https://leetcode.cn/problems/minimize-malware-spread-ii/)
