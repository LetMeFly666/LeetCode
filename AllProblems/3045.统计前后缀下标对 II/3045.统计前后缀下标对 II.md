...
tags: [题解, LeetCode, 困难, 字典树, 数组, 字符串, 字符串匹配, 哈希函数, 滚动哈希]
---

# 【LetMeFly】3045.统计前后缀下标对 II

力扣题目链接：[https://leetcode.cn/problems/count-prefix-and-suffix-pairs-ii/](https://leetcode.cn/problems/count-prefix-and-suffix-pairs-ii/)
