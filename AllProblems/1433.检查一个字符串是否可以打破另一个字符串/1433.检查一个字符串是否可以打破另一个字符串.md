...
date: 2022-06-02 20-06-26
tags: [题解, LeetCode, 中等, 贪心, 字符串, 排序]
---

# 【LetMeFly】1433.检查一个字符串是否可以打破另一个字符串

力扣题目链接：[https://leetcode.cn/problems/check-if-a-string-can-break-another-string/](https://leetcode.cn/problems/check-if-a-string-can-break-another-string/)
