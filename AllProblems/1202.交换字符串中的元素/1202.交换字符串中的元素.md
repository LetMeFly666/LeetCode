...
tags: [题解, LeetCode, 中等, 深度优先搜索, 广度优先搜索, 并查集, 数组, 哈希表, 字符串, 排序]
---

# 【LetMeFly】1202.交换字符串中的元素

力扣题目链接：[https://leetcode.cn/problems/smallest-string-with-swaps/](https://leetcode.cn/problems/smallest-string-with-swaps/)
