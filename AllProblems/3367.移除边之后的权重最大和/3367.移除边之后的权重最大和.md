...
tags: [题解, LeetCode, 困难, 树, 深度优先搜索, 动态规划, 排序]
---

# 【LetMeFly】3367.移除边之后的权重最大和

力扣题目链接：[https://leetcode.cn/problems/maximize-sum-of-weights-after-edge-removals/](https://leetcode.cn/problems/maximize-sum-of-weights-after-edge-removals/)
