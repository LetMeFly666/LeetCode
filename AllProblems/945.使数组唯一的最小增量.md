...
tags: [题解, LeetCode, 中等, 贪心, 数组, 计数, 排序]
---

# 【LetMeFly】945.使数组唯一的最小增量

力扣题目链接：[https://leetcode.cn/problems/minimum-increment-to-make-array-unique/](https://leetcode.cn/problems/minimum-increment-to-make-array-unique/)
