...
tags: [题解, LeetCode, 中等, 位运算, 数组, 哈希表, 字符串, 前缀和]
---

# 【LetMeFly】1177.构建回文串检测

力扣题目链接：[https://leetcode.cn/problems/can-make-palindrome-from-substring/](https://leetcode.cn/problems/can-make-palindrome-from-substring/)
