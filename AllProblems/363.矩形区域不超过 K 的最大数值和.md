...
tags: [题解, LeetCode, 困难, 数组, 二分查找, 动态规划, 矩阵, 有序集合]
---

# 【LetMeFly】363.矩形区域不超过 K 的最大数值和

力扣题目链接：[https://leetcode.cn/problems/max-sum-of-rectangle-no-larger-than-k/](https://leetcode.cn/problems/max-sum-of-rectangle-no-larger-than-k/)
