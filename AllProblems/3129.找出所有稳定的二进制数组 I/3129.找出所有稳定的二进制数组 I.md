...
tags: [题解, LeetCode, 中等, 动态规划, 前缀和]
---

# 【LetMeFly】3129.找出所有稳定的二进制数组 I

力扣题目链接：[https://leetcode.cn/problems/find-all-possible-stable-binary-arrays-i/](https://leetcode.cn/problems/find-all-possible-stable-binary-arrays-i/)
