...
tags: [题解, LeetCode, 困难, 队列, 数组, 动态规划, 滑动窗口, 单调队列, 堆（优先队列）]
---

# 【LetMeFly】1425.带限制的子序列和

力扣题目链接：[https://leetcode.cn/problems/constrained-subsequence-sum/](https://leetcode.cn/problems/constrained-subsequence-sum/)
