...
tags: [题解, LeetCode, 困难, 设计, 哈希表, 链表, 双向链表]
---

# 【LetMeFly】432.全 O(1) 的数据结构

力扣题目链接：[https://leetcode.cn/problems/all-oone-data-structure/](https://leetcode.cn/problems/all-oone-data-structure/)
