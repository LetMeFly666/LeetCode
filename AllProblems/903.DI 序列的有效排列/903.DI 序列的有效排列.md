...
date: 2022-06-02 20-01-38
tags: [题解, LeetCode, 困难, 字符串, 动态规划, 前缀和]
---

# 【LetMeFly】903.DI 序列的有效排列

力扣题目链接：[https://leetcode.cn/problems/valid-permutations-for-di-sequence/](https://leetcode.cn/problems/valid-permutations-for-di-sequence/)
