...
date: 2022-06-02 20-14-15
tags: [题解, LeetCode, 困难, 数组, 哈希表, 数学, 计数, 数论]
---

# 【LetMeFly】2183.统计可以被 K 整除的下标对数目

力扣题目链接：[https://leetcode.cn/problems/count-array-pairs-divisible-by-k/](https://leetcode.cn/problems/count-array-pairs-divisible-by-k/)
