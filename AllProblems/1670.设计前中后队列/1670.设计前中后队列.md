...
tags: [题解, LeetCode, 中等, 设计, 队列, 数组, 链表, 数据流, 双向链表]
---

# 【LetMeFly】1670.设计前中后队列

力扣题目链接：[https://leetcode.cn/problems/design-front-middle-back-queue/](https://leetcode.cn/problems/design-front-middle-back-queue/)
