...
tags: [题解, LeetCode, 困难, 贪心, 队列, 数组, 二分查找, 前缀和, 滑动窗口]
---

# 【LetMeFly】2528.最大化城市的最小供电站数目

力扣题目链接：[https://leetcode.cn/problems/maximize-the-minimum-powered-city/](https://leetcode.cn/problems/maximize-the-minimum-powered-city/)
