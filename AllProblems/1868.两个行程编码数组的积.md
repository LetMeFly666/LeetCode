...
# 【LetMeFly】1868.两个行程编码数组的积

力扣题目链接：[https://leetcode.cn/problems/product-of-two-run-length-encoded-arrays/](https://leetcode.cn/problems/product-of-two-run-length-encoded-arrays/)
