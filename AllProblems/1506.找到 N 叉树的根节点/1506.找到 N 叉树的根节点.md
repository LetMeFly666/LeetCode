...
tags: [题解, LeetCode, 中等, 位运算, 树, 深度优先搜索, 哈希表]
---

# 【LetMeFly】1506.找到 N 叉树的根节点

力扣题目链接：[https://leetcode.cn/problems/find-root-of-n-ary-tree/](https://leetcode.cn/problems/find-root-of-n-ary-tree/)
