...
# 【LetMeFly】2896.执行操作使两个字符串相等

力扣题目链接：[https://leetcode.cn/problems/apply-operations-to-make-two-strings-equal/](https://leetcode.cn/problems/apply-operations-to-make-two-strings-equal/)
