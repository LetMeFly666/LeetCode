...
# 【LetMeFly】2124.检查是否所有 A 都在 B 之前

力扣题目链接：[https://leetcode.cn/problems/check-if-all-as-appears-before-all-bs/](https://leetcode.cn/problems/check-if-all-as-appears-before-all-bs/)
