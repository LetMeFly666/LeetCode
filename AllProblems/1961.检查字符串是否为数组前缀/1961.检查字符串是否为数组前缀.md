...
date: 2022-06-02 20-11-57
tags: [题解, LeetCode, 简单, 数组, 双指针, 字符串]
---

# 【LetMeFly】1961.检查字符串是否为数组前缀

力扣题目链接：[https://leetcode.cn/problems/check-if-string-is-a-prefix-of-array/](https://leetcode.cn/problems/check-if-string-is-a-prefix-of-array/)
