...
date: 2024-06-04 22-05-23
tags: [题解, LeetCode, 困难, 贪心, 数组, 前缀和, 滑动窗口]
---

# 【LetMeFly】3086.拾起 K 个 1 需要的最少行动次数

力扣题目链接：[https://leetcode.cn/problems/minimum-moves-to-pick-k-ones/](https://leetcode.cn/problems/minimum-moves-to-pick-k-ones/)
