...
tags: [题解, LeetCode, 困难, 数组, 字符串匹配, 哈希函数, 滚动哈希]
---

# 【LetMeFly】3036.匹配模式数组的子数组数目 II

力扣题目链接：[https://leetcode.cn/problems/number-of-subarrays-that-match-a-pattern-ii/](https://leetcode.cn/problems/number-of-subarrays-that-match-a-pattern-ii/)
