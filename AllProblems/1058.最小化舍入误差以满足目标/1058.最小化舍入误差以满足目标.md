...
tags: [题解, LeetCode, 中等, 贪心, 数组, 数学, 字符串]
---

# 【LetMeFly】1058.最小化舍入误差以满足目标

力扣题目链接：[https://leetcode.cn/problems/minimize-rounding-error-to-meet-target/](https://leetcode.cn/problems/minimize-rounding-error-to-meet-target/)
