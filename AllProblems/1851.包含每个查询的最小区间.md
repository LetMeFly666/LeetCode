...
date: 2022-06-02 20-10-47
tags: [题解, LeetCode, 困难, 数组, 二分查找, 排序, 扫描线, 堆（优先队列）]
---

# 【LetMeFly】1851.包含每个查询的最小区间

力扣题目链接：[https://leetcode.cn/problems/minimum-interval-to-include-each-query/](https://leetcode.cn/problems/minimum-interval-to-include-each-query/)
