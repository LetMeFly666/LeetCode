...
tags: [题解, LeetCode, 中等, 深度优先搜索, 广度优先搜索, 图, 交互]
---

# 【LetMeFly】1778.未知网格中的最短路径

力扣题目链接：[https://leetcode.cn/problems/shortest-path-in-a-hidden-grid/](https://leetcode.cn/problems/shortest-path-in-a-hidden-grid/)
