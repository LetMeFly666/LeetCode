---
title: 3805.统计凯撒加密对数目
date: 2026-02-10 23-00-18
tags: [题解, LeetCode, 中等, 数组, 哈希表, 数学, 字符串, 计数]
---

# 【LetMeFly】3805.统计凯撒加密对数目

力扣题目链接：[https://leetcode.cn/problems/count-caesar-cipher-pairs/](https://leetcode.cn/problems/count-caesar-cipher-pairs/)
