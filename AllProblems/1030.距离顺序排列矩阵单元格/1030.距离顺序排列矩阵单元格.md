...
tags: [题解, LeetCode, 简单, 几何, 数组, 数学, 矩阵, 排序]
---

# 【LetMeFly】1030.距离顺序排列矩阵单元格

力扣题目链接：[https://leetcode.cn/problems/matrix-cells-in-distance-order/](https://leetcode.cn/problems/matrix-cells-in-distance-order/)
