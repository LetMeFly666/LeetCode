...
date: 2023-10-10 14-41-27
tags: [题解, LeetCode, 困难, 深度优先搜索, 广度优先搜索, 图, 动态规划]
---

# 【LetMeFly】2858.可以到达每一个节点的最少边反转次数

力扣题目链接：[https://leetcode.cn/problems/minimum-edge-reversals-so-every-node-is-reachable/](https://leetcode.cn/problems/minimum-edge-reversals-so-every-node-is-reachable/)
