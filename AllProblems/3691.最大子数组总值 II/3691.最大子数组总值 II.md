...
tags: [题解, LeetCode, 困难, 贪心, 线段树, 数组, 堆（优先队列）]
---

# 【LetMeFly】3691.最大子数组总值 II

力扣题目链接：[https://leetcode.cn/problems/maximum-total-subarray-value-ii/](https://leetcode.cn/problems/maximum-total-subarray-value-ii/)
