...
date: 2022-06-02 20-00-29
tags: [题解, LeetCode, 困难, 数组, 二分查找]
---

# 【LetMeFly】774.最小化去加油站的最大距离

力扣题目链接：[https://leetcode.cn/problems/minimize-max-distance-to-gas-station/](https://leetcode.cn/problems/minimize-max-distance-to-gas-station/)
