...
tags: [题解, LeetCode, 中等, 数组, 字符串, 回溯, 枚举]
---

# 【LetMeFly】949.给定数字能组成的最大时间

力扣题目链接：[https://leetcode.cn/problems/largest-time-for-given-digits/](https://leetcode.cn/problems/largest-time-for-given-digits/)
