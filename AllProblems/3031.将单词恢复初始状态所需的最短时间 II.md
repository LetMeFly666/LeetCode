...
# 【LetMeFly】3031.将单词恢复初始状态所需的最短时间 II

力扣题目链接：[https://leetcode.cn/problems/minimum-time-to-revert-word-to-initial-state-ii/](https://leetcode.cn/problems/minimum-time-to-revert-word-to-initial-state-ii/)
