...
date: 2024-12-19 16-59-54
tags: [题解, LeetCode, 困难, 树, 深度优先搜索, 数组, 哈希表, 字符串, 哈希函数]
---

# 【LetMeFly】3327.判断 DFS 字符串是否是回文串

力扣题目链接：[https://leetcode.cn/problems/check-if-dfs-strings-are-palindromes/](https://leetcode.cn/problems/check-if-dfs-strings-are-palindromes/)
