...
date: 2023-01-03 18-53-22
tags: [题解, LeetCode, 困难, 树状数组, 线段树, 数组, 二分查找, 分治, 有序集合, 归并排序]
---

# 【LetMeFly】2426.满足不等式的数对数目

力扣题目链接：[https://leetcode.cn/problems/number-of-pairs-satisfying-inequality/](https://leetcode.cn/problems/number-of-pairs-satisfying-inequality/)
