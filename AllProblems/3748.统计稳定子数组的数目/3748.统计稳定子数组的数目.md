...
tags: [题解, LeetCode, 困难, 数组, 二分查找, 前缀和]
---

# 【LetMeFly】3748.统计稳定子数组的数目

力扣题目链接：[https://leetcode.cn/problems/count-stable-subarrays/](https://leetcode.cn/problems/count-stable-subarrays/)
