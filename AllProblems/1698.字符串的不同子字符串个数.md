...
tags: [题解, LeetCode, 中等, 字典树, 字符串, 后缀数组, 哈希函数, 滚动哈希]
---

# 【LetMeFly】1698.字符串的不同子字符串个数

力扣题目链接：[https://leetcode.cn/problems/number-of-distinct-substrings-in-a-string/](https://leetcode.cn/problems/number-of-distinct-substrings-in-a-string/)
