...
date: 2022-06-02 20-09-40
tags: [题解, LeetCode, 中等, 栈, 设计, 树状数组, 数组, 哈希表, 有序集合]
---

# 【LetMeFly】1756.设计最近使用（MRU）队列

力扣题目链接：[https://leetcode.cn/problems/design-most-recently-used-queue/](https://leetcode.cn/problems/design-most-recently-used-queue/)
