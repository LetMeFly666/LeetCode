---
title: 588.设计内存文件系统
date: 2022-06-02 19-58-55
tags: [题解, LeetCode, 困难, 设计, 字典树, 哈希表, 字符串]
---

# 【LetMeFly】588.设计内存文件系统

力扣题目链接：[https://leetcode.cn/problems/design-in-memory-file-system/](https://leetcode.cn/problems/design-in-memory-file-system/)
