...
tags: [题解, LeetCode, 中等, 贪心, 数组, 数学, 二分查找, 排序, 堆（优先队列）]
---

# 【LetMeFly】1648.销售价值减少的颜色球

力扣题目链接：[https://leetcode.cn/problems/sell-diminishing-valued-colored-balls/](https://leetcode.cn/problems/sell-diminishing-valued-colored-balls/)
