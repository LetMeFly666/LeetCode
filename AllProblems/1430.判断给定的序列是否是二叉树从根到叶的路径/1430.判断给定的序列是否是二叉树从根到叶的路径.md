...
date: 2022-06-02 20-06-24
tags: [题解, LeetCode, 中等, 树, 深度优先搜索, 广度优先搜索, 二叉树]
---

# 【LetMeFly】1430.判断给定的序列是否是二叉树从根到叶的路径

力扣题目链接：[https://leetcode.cn/problems/check-if-a-string-is-a-valid-sequence-from-root-to-leaves-path-in-a-binary-tree/](https://leetcode.cn/problems/check-if-a-string-is-a-valid-sequence-from-root-to-leaves-path-in-a-binary-tree/)
