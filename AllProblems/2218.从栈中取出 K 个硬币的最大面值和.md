...
date: 2022-06-02 20-14-36
tags: [题解, LeetCode, 困难, 数组, 动态规划, 前缀和]
---

# 【LetMeFly】2218.从栈中取出 K 个硬币的最大面值和

力扣题目链接：[https://leetcode.cn/problems/maximum-value-of-k-coins-from-piles/](https://leetcode.cn/problems/maximum-value-of-k-coins-from-piles/)
