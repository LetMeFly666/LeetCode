...
tags: [题解, LeetCode, 中等, 位运算, 哈希表, 字符串, 动态规划, 前缀和]
---

# 【LetMeFly】1525.字符串的好分割数目

力扣题目链接：[https://leetcode.cn/problems/number-of-good-ways-to-split-a-string/](https://leetcode.cn/problems/number-of-good-ways-to-split-a-string/)
