---
title: 339.嵌套列表权重和
date: 2022-06-02 19-56-47
tags: [题解, LeetCode, 中等, 深度优先搜索, 广度优先搜索]
---

# 【LetMeFly】339.嵌套列表权重和

力扣题目链接：[https://leetcode.cn/problems/nested-list-weight-sum/](https://leetcode.cn/problems/nested-list-weight-sum/)
