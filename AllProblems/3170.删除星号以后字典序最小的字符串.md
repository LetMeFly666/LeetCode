...
tags: [题解, LeetCode, 中等, 栈, 贪心, 哈希表, 字符串, 堆（优先队列）]
---

# 【LetMeFly】3170.删除星号以后字典序最小的字符串

力扣题目链接：[https://leetcode.cn/problems/lexicographically-minimum-string-after-removing-stars/](https://leetcode.cn/problems/lexicographically-minimum-string-after-removing-stars/)
