...
date: 2025-09-13 13-24-15
tags: [题解, LeetCode, 简单, 数组, 哈希表, 数学, 计数, 数论]
---

# 【LetMeFly】3591.检查元素频次是否为质数

力扣题目链接：[https://leetcode.cn/problems/check-if-any-element-has-prime-frequency/](https://leetcode.cn/problems/check-if-any-element-has-prime-frequency/)
