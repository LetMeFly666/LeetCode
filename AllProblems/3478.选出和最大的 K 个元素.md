...
date: 2025-04-08 23-05-02
tags: [题解, LeetCode, 中等, 数组, 排序, 堆（优先队列）]
---

# 【LetMeFly】3478.选出和最大的 K 个元素

力扣题目链接：[https://leetcode.cn/problems/choose-k-elements-with-maximum-sum/](https://leetcode.cn/problems/choose-k-elements-with-maximum-sum/)
