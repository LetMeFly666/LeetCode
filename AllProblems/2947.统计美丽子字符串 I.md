...
tags: [题解, LeetCode, 中等, 哈希表, 数学, 字符串, 枚举, 数论, 前缀和]
---

# 【LetMeFly】2947.统计美丽子字符串 I

力扣题目链接：[https://leetcode.cn/problems/count-beautiful-substrings-i/](https://leetcode.cn/problems/count-beautiful-substrings-i/)
