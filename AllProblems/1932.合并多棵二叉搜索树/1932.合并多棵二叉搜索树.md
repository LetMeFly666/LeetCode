...
date: 2022-06-02 20-11-38
tags: [题解, LeetCode, 困难, 树, 深度优先搜索, 二叉搜索树, 数组, 哈希表, 二叉树]
---

# 【LetMeFly】1932.合并多棵二叉搜索树

力扣题目链接：[https://leetcode.cn/problems/merge-bsts-to-create-single-bst/](https://leetcode.cn/problems/merge-bsts-to-create-single-bst/)
