...
date: 2022-06-02 19-59-28
tags: [题解, LeetCode, 中等, 数组, 双指针, 二分查找, 排序, 滑动窗口, 堆（优先队列）]
---

# 【LetMeFly】658.找到 K 个最接近的元素

力扣题目链接：[https://leetcode.cn/problems/find-k-closest-elements/](https://leetcode.cn/problems/find-k-closest-elements/)
