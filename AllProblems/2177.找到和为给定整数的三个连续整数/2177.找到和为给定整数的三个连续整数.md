...
date: 2022-06-02 20-14-11
tags: [题解, LeetCode, 中等, 数学, 模拟]
---

# 【LetMeFly】2177.找到和为给定整数的三个连续整数

力扣题目链接：[https://leetcode.cn/problems/find-three-consecutive-integers-that-sum-to-a-given-number/](https://leetcode.cn/problems/find-three-consecutive-integers-that-sum-to-a-given-number/)
