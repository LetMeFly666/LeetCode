...
date: 2022-06-02 20-11-49
tags: [题解, LeetCode, 困难, 深度优先搜索, 字典树, 数组, 哈希表, 字符串, 排序, 哈希函数]
---

# 【LetMeFly】1948.删除系统中的重复文件夹

力扣题目链接：[https://leetcode.cn/problems/delete-duplicate-folders-in-system/](https://leetcode.cn/problems/delete-duplicate-folders-in-system/)
