...
date: 2022-06-02 20-09-51
tags: [题解, LeetCode, 困难, 字符串, 动态规划]
---

# 【LetMeFly】1771.由子序列构造的最长回文串的长度

力扣题目链接：[https://leetcode.cn/problems/maximize-palindrome-length-from-subsequences/](https://leetcode.cn/problems/maximize-palindrome-length-from-subsequences/)
