...
tags: [题解, LeetCode, 困难, 数组, 二分查找, 矩阵, 堆（优先队列）]
---

# 【LetMeFly】1439.有序矩阵中的第 k 个最小数组和

力扣题目链接：[https://leetcode.cn/problems/find-the-kth-smallest-sum-of-a-matrix-with-sorted-rows/](https://leetcode.cn/problems/find-the-kth-smallest-sum-of-a-matrix-with-sorted-rows/)
