...
date: 2022-06-02 20-04-08
tags: [题解, LeetCode, 简单, 数学, 字符串]
---

# 【LetMeFly】1180.统计只含单一字母的子串

力扣题目链接：[https://leetcode.cn/problems/count-substrings-with-only-one-distinct-letter/](https://leetcode.cn/problems/count-substrings-with-only-one-distinct-letter/)
