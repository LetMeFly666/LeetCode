...
# 【LetMeFly】1864.构成交替字符串需要的最小交换次数

力扣题目链接：[https://leetcode.cn/problems/minimum-number-of-swaps-to-make-the-binary-string-alternating/](https://leetcode.cn/problems/minimum-number-of-swaps-to-make-the-binary-string-alternating/)
