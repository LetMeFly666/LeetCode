...
tags: [题解, LeetCode, 困难, 位运算, 数组, 数学, 二分查找, 组合数学, 数论]
---

# 【LetMeFly】3116.单面值组合的第 K 小金额

力扣题目链接：[https://leetcode.cn/problems/kth-smallest-amount-with-single-denomination-combination/](https://leetcode.cn/problems/kth-smallest-amount-with-single-denomination-combination/)
