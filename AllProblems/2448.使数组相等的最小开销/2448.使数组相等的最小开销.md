...
tags: [题解, LeetCode, 困难, 贪心, 数组, 二分查找, 前缀和, 排序]
---

# 【LetMeFly】2448.使数组相等的最小开销

力扣题目链接：[https://leetcode.cn/problems/minimum-cost-to-make-array-equal/](https://leetcode.cn/problems/minimum-cost-to-make-array-equal/)
