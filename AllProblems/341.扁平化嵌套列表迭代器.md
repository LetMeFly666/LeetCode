...
tags: [题解, LeetCode, 中等, 栈, 树, 深度优先搜索, 设计, 队列, 迭代器]
---

# 【LetMeFly】341.扁平化嵌套列表迭代器

力扣题目链接：[https://leetcode.cn/problems/flatten-nested-list-iterator/](https://leetcode.cn/problems/flatten-nested-list-iterator/)
