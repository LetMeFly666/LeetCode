...
date: 2022-06-02 20-07-26
tags: [题解, LeetCode, 中等, 哈希表, 字符串]
---

# 【LetMeFly】1540.K 次操作转变字符串

力扣题目链接：[https://leetcode.cn/problems/can-convert-string-in-k-moves/](https://leetcode.cn/problems/can-convert-string-in-k-moves/)
