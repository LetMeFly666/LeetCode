...
tags: [题解, LeetCode, 中等, 设计, 哈希表, 字符串, 二分查找, 有序集合, 排序]
---

# 【LetMeFly】1348.推文计数

力扣题目链接：[https://leetcode.cn/problems/tweet-counts-per-frequency/](https://leetcode.cn/problems/tweet-counts-per-frequency/)
