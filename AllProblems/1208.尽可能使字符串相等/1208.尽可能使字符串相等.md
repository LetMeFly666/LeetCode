...
tags: [题解, LeetCode, 中等, 字符串, 二分查找, 前缀和, 滑动窗口]
---

# 【LetMeFly】1208.尽可能使字符串相等

力扣题目链接：[https://leetcode.cn/problems/get-equal-substrings-within-budget/](https://leetcode.cn/problems/get-equal-substrings-within-budget/)
