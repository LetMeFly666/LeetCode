...
tags: [题解, LeetCode, 困难, 队列, 数组, 分治, 动态规划, 前缀和, 单调队列]
---

# 【LetMeFly】3826.最小分割分数

力扣题目链接：[https://leetcode.cn/problems/minimum-partition-score/](https://leetcode.cn/problems/minimum-partition-score/)
