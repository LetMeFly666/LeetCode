...
date: 2022-06-02 20-09-39
tags: [题解, LeetCode, 困难, 位运算, 数组, 双指针, 动态规划, 状态压缩, 排序]
---

# 【LetMeFly】1755.最接近目标值的子序列和

力扣题目链接：[https://leetcode.cn/problems/closest-subsequence-sum/](https://leetcode.cn/problems/closest-subsequence-sum/)
