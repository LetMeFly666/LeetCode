---
title: 3752.字典序最小和为目标值且绝对值是排列的数组
date: 2026-02-10 22-59-52
tags: [题解, LeetCode, 中等, 贪心, 数组, 数学, 双指针, 排序]
---

# 【LetMeFly】3752.字典序最小和为目标值且绝对值是排列的数组

力扣题目链接：[https://leetcode.cn/problems/lexicographically-smallest-negated-permutation-that-sums-to-target/](https://leetcode.cn/problems/lexicographically-smallest-negated-permutation-that-sums-to-target/)
