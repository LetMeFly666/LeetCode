...
tags: [题解, LeetCode, 中等, 字符串, 字符串匹配]
---

# 【LetMeFly】686.重复叠加字符串匹配

力扣题目链接：[https://leetcode.cn/problems/repeated-string-match/](https://leetcode.cn/problems/repeated-string-match/)
