...
date: 2022-06-02 20-11-29
tags: [题解, LeetCode, 困难, 树, 深度优先搜索, 图, 拓扑排序, 数组, 数学, 动态规划, 组合数学]
---

# 【LetMeFly】1916.统计为蚁群构筑房间的不同顺序

力扣题目链接：[https://leetcode.cn/problems/count-ways-to-build-rooms-in-an-ant-colony/](https://leetcode.cn/problems/count-ways-to-build-rooms-in-an-ant-colony/)
