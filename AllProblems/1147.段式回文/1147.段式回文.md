...
tags: [题解, LeetCode, 困难, 贪心, 双指针, 字符串, 动态规划, 哈希函数, 滚动哈希]
---

# 【LetMeFly】1147.段式回文

力扣题目链接：[https://leetcode.cn/problems/longest-chunked-palindrome-decomposition/](https://leetcode.cn/problems/longest-chunked-palindrome-decomposition/)
