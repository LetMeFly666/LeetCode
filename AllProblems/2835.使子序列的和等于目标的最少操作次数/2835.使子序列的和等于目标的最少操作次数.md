...
date: 2023-10-10 14-40-56
tags: [题解, LeetCode, 困难, 贪心, 位运算, 数组]
---

# 【LetMeFly】2835.使子序列的和等于目标的最少操作次数

力扣题目链接：[https://leetcode.cn/problems/minimum-operations-to-form-subsequence-with-target-sum/](https://leetcode.cn/problems/minimum-operations-to-form-subsequence-with-target-sum/)
