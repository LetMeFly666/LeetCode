...
date: 2026-02-10 22-59-36
tags: [题解, LeetCode, 困难, 树, 深度优先搜索, 数组, 哈希表, 数学, 计数, 数论]
---

# 【LetMeFly】3715.完全平方数的祖先个数总和

力扣题目链接：[https://leetcode.cn/problems/sum-of-perfect-square-ancestors/](https://leetcode.cn/problems/sum-of-perfect-square-ancestors/)
