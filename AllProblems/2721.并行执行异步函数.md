...
# 【LetMeFly】2721.并行执行异步函数

力扣题目链接：[https://leetcode.cn/problems/execute-asynchronous-functions-in-parallel/](https://leetcode.cn/problems/execute-asynchronous-functions-in-parallel/)
