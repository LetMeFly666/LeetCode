...
tags: [题解, LeetCode, 困难, 字符串, 字符串匹配]
---

# 【LetMeFly】3303.第一个几乎相等子字符串的下标

力扣题目链接：[https://leetcode.cn/problems/find-the-occurrence-of-first-almost-equal-substring/](https://leetcode.cn/problems/find-the-occurrence-of-first-almost-equal-substring/)
