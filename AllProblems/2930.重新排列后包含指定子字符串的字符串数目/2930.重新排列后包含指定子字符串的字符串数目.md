...
date: 2024-01-24 13-55-22
tags: [题解, LeetCode, 中等, 数学, 动态规划, 组合数学]
---

# 【LetMeFly】2930.重新排列后包含指定子字符串的字符串数目

力扣题目链接：[https://leetcode.cn/problems/number-of-strings-which-can-be-rearranged-to-contain-substring/](https://leetcode.cn/problems/number-of-strings-which-can-be-rearranged-to-contain-substring/)
