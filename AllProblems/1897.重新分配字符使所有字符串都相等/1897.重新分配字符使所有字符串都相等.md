...
date: 2022-06-02 20-11-17
tags: [题解, LeetCode, 简单, 哈希表, 字符串, 计数]
---

# 【LetMeFly】1897.重新分配字符使所有字符串都相等

力扣题目链接：[https://leetcode.cn/problems/redistribute-characters-to-make-all-strings-equal/](https://leetcode.cn/problems/redistribute-characters-to-make-all-strings-equal/)
