...
date: 2022-06-02 19-58-15
tags: [题解, LeetCode, 中等, 树, 深度优先搜索, 哈希表, 二叉树]
---

# 【LetMeFly】508.出现次数最多的子树元素和

力扣题目链接：[https://leetcode.cn/problems/most-frequent-subtree-sum/](https://leetcode.cn/problems/most-frequent-subtree-sum/)
