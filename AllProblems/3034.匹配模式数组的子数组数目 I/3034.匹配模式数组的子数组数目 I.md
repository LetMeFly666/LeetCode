...
date: 2024-06-04 22-05-04
tags: [题解, LeetCode, 中等, 数组, 字符串匹配, 哈希函数, 滚动哈希]
---

# 【LetMeFly】3034.匹配模式数组的子数组数目 I

力扣题目链接：[https://leetcode.cn/problems/number-of-subarrays-that-match-a-pattern-i/](https://leetcode.cn/problems/number-of-subarrays-that-match-a-pattern-i/)
