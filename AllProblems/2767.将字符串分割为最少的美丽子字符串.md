...
date: 2023-10-10 14-40-25
tags: [题解, LeetCode, 中等, 哈希表, 字符串, 动态规划, 回溯]
---

# 【LetMeFly】2767.将字符串分割为最少的美丽子字符串

力扣题目链接：[https://leetcode.cn/problems/partition-string-into-minimum-beautiful-substrings/](https://leetcode.cn/problems/partition-string-into-minimum-beautiful-substrings/)
