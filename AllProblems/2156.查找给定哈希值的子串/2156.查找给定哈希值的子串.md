...
date: 2022-06-02 20-13-59
tags: [题解, LeetCode, 困难, 字符串, 滑动窗口, 哈希函数, 滚动哈希]
---

# 【LetMeFly】2156.查找给定哈希值的子串

力扣题目链接：[https://leetcode.cn/problems/find-substring-with-given-hash-value/](https://leetcode.cn/problems/find-substring-with-given-hash-value/)
