...
tags: [题解, LeetCode, 中等, 数组, 哈希表, 双指针, 字符串, 动态规划, 排序]
---

# 【LetMeFly】1048.最长字符串链

力扣题目链接：[https://leetcode.cn/problems/longest-string-chain/](https://leetcode.cn/problems/longest-string-chain/)
