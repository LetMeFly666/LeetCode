...
date: 2022-06-02 20-06-36
tags: [题解, LeetCode, 困难, 数组, 动态规划]
---

# 【LetMeFly】1449.数位成本和为目标值的最大数字

力扣题目链接：[https://leetcode.cn/problems/form-largest-integer-with-digits-that-add-up-to-target/](https://leetcode.cn/problems/form-largest-integer-with-digits-that-add-up-to-target/)
