...
tags: [题解, LeetCode, 中等, 数组, 双指针, 字符串, 排序]
---

# 【LetMeFly】524.通过删除字母匹配到字典里最长单词

力扣题目链接：[https://leetcode.cn/problems/longest-word-in-dictionary-through-deleting/](https://leetcode.cn/problems/longest-word-in-dictionary-through-deleting/)
