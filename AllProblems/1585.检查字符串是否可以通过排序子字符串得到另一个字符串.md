...
date: 2022-06-02 20-07-53
tags: [题解, LeetCode, 困难, 贪心, 字符串, 排序]
---

# 【LetMeFly】1585.检查字符串是否可以通过排序子字符串得到另一个字符串

力扣题目链接：[https://leetcode.cn/problems/check-if-string-is-transformable-with-substring-sort-operations/](https://leetcode.cn/problems/check-if-string-is-transformable-with-substring-sort-operations/)
