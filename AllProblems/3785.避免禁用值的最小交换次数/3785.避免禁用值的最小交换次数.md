---
title: 3785.避免禁用值的最小交换次数
date: 2026-02-10 23-00-09
tags: [题解, LeetCode, 困难, 贪心, 数组, 哈希表, 计数]
---

# 【LetMeFly】3785.避免禁用值的最小交换次数

力扣题目链接：[https://leetcode.cn/problems/minimum-swaps-to-avoid-forbidden-values/](https://leetcode.cn/problems/minimum-swaps-to-avoid-forbidden-values/)
