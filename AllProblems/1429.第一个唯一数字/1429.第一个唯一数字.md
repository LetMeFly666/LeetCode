...
tags: [题解, LeetCode, 中等, 设计, 队列, 数组, 哈希表, 数据流]
---

# 【LetMeFly】1429.第一个唯一数字

力扣题目链接：[https://leetcode.cn/problems/first-unique-number/](https://leetcode.cn/problems/first-unique-number/)
