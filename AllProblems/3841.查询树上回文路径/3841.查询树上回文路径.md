...
tags: [题解, LeetCode, 困难, 位运算, 树, 深度优先搜索, 线段树, 数组, 字符串, 分治]
---

# 【LetMeFly】3841.查询树上回文路径

力扣题目链接：[https://leetcode.cn/problems/palindromic-path-queries-in-a-tree/](https://leetcode.cn/problems/palindromic-path-queries-in-a-tree/)
