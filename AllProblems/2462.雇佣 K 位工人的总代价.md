...
tags: [题解, LeetCode, 中等, 数组, 双指针, 模拟, 堆（优先队列）]
---

# 【LetMeFly】2462.雇佣 K 位工人的总代价

力扣题目链接：[https://leetcode.cn/problems/total-cost-to-hire-k-workers/](https://leetcode.cn/problems/total-cost-to-hire-k-workers/)
