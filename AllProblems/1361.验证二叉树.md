...
tags: [题解, LeetCode, 中等, 树, 深度优先搜索, 广度优先搜索, 并查集, 图, 二叉树]
---

# 【LetMeFly】1361.验证二叉树

力扣题目链接：[https://leetcode.cn/problems/validate-binary-tree-nodes/](https://leetcode.cn/problems/validate-binary-tree-nodes/)
