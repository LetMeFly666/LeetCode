...
date: 2022-06-02 20-07-17
tags: [题解, LeetCode, 中等, 数组, 数学, 动态规划, 前缀和]
---

# 【LetMeFly】1524.和为奇数的子数组数目

力扣题目链接：[https://leetcode.cn/problems/number-of-sub-arrays-with-odd-sum/](https://leetcode.cn/problems/number-of-sub-arrays-with-odd-sum/)
