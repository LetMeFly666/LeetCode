...
tags: [题解, LeetCode, 困难, 数组, 枚举, 矩阵]
---

# 【LetMeFly】3197.包含所有 1 的最小矩形面积 II

力扣题目链接：[https://leetcode.cn/problems/find-the-minimum-area-to-cover-all-ones-ii/](https://leetcode.cn/problems/find-the-minimum-area-to-cover-all-ones-ii/)
