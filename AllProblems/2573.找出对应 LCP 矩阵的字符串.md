...
tags: [题解, LeetCode, 困难, 贪心, 并查集, 数组, 字符串, 动态规划, 矩阵]
---

# 【LetMeFly】2573.找出对应 LCP 矩阵的字符串

力扣题目链接：[https://leetcode.cn/problems/find-the-string-with-lcp/](https://leetcode.cn/problems/find-the-string-with-lcp/)
