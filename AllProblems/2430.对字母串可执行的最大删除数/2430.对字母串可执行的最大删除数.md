...
tags: [题解, LeetCode, 困难, 字符串, 动态规划, 字符串匹配, 哈希函数, 滚动哈希]
---

# 【LetMeFly】2430.对字母串可执行的最大删除数

力扣题目链接：[https://leetcode.cn/problems/maximum-deletions-on-a-string/](https://leetcode.cn/problems/maximum-deletions-on-a-string/)
