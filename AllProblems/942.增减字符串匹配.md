---
title: 942.增减字符串匹配
date: 2022-06-02 20-01-59
tags: [题解, LeetCode, 简单, 贪心, 数组, 数学, 双指针, 字符串]
---

# 【LetMeFly】942.增减字符串匹配

力扣题目链接：[https://leetcode.cn/problems/di-string-match/](https://leetcode.cn/problems/di-string-match/)
