...
date: 2022-06-02 20-15-12
tags: [题解, LeetCode, 困难, 广度优先搜索, 图, 数组, 矩阵, 最短路, 堆（优先队列）]
---

# 【LetMeFly】2290.到达角落需要移除障碍物的最小数目

力扣题目链接：[https://leetcode.cn/problems/minimum-obstacle-removal-to-reach-corner/](https://leetcode.cn/problems/minimum-obstacle-removal-to-reach-corner/)
