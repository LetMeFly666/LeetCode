...
date: 2022-06-02 20-12-42
tags: [题解, LeetCode, 困难, 位运算, 数组, 双指针, 二分查找, 动态规划, 位掩码, 有序集合, 排序]
---

# 【LetMeFly】2035.将数组分成两个数组并最小化数组和的差

力扣题目链接：[https://leetcode.cn/problems/partition-array-into-two-arrays-to-minimize-sum-difference/](https://leetcode.cn/problems/partition-array-into-two-arrays-to-minimize-sum-difference/)
