...
tags: [题解, LeetCode, 中等, 字典树, 数组, 哈希表, 字符串, 动态规划]
---

# 【LetMeFly】2707.字符串中的额外字符

力扣题目链接：[https://leetcode.cn/problems/extra-characters-in-a-string/](https://leetcode.cn/problems/extra-characters-in-a-string/)
