...
tags: [题解, LeetCode, 困难, 贪心, 数组, 数学, 二分查找, 排序]
---

# 【LetMeFly】2790.长度递增组的最大数目

力扣题目链接：[https://leetcode.cn/problems/maximum-number-of-groups-with-increasing-length/](https://leetcode.cn/problems/maximum-number-of-groups-with-increasing-length/)
